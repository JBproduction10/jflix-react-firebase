...
export function BrowseContainer({ slides }) {
  ...
  return profile.displayName ? (
    <>
      ...
      <Header src="the-equalizer-3" dontShowOnSmallViewPort>
      <Header.Frame>
          <Header.Group>
        ...
        <Header.Feature>
          <Header.FeatureCallOut>Watch The Equalizer 3</Header.FeatureCallOut>
          <Header.Text>
            ...
            <Card.Entities>
              {slideItem.data.map((item) => (
                <Card.Item key={item.docId} item={item}>
                  <Card.Image src={`/images/${category}/${item.genre}/${item.slug}/medium.jpg`} />
                  <Card.Meta>
